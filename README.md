...
> 项目仍在持续开发中。AI 文本、图片和视频能力需要配置对应服务；视频生成功能默认关闭，生成视频需要手动点击。
...
| 截图 | 说明 |
|------|------|
| ![小说大纲工作台](img/小说大纲工作台.png) | 小说大纲工作台 |
| ![小说全文工作台](img/小说全文工作台.png) | 小说全文工作台 |
| ![历史作品](img/历史作品.png) | 历史作品 |
| ![视频创作工作台](img/视频创作工作台.png) | 视频创作工作台 |
| ![资产库](img/资产库.png) | 资产库 |
| ![模型管理](img/模型管理.png) | 模型管理 |
| ![AI智能助手_1](img/AI智能助手_1.png) | AI智能助手_1 |
| ![AI智能助手_2](img/AI智能助手_2.png) | AI智能助手_2 |
